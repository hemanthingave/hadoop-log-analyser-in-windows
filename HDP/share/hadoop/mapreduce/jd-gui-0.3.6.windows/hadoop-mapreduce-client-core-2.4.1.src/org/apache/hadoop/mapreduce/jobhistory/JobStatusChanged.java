...
/*  13:    */ 
/*  14:    */ @AvroGenerated
/*  15:    */ public class JobStatusChanged
/*  16:    */   extends SpecificRecordBase
/*  17:    */   implements SpecificRecord
/*  18:    */ {
/*  19: 10 */   public static final Schema SCHEMA$ = new Schema.Parser().parse("{\"type\":\"record\",\"name\":\"JobStatusChanged\",\"namespace\":\"org.apache.hadoop.mapreduce.jobhistory\",\"fields\":[{\"name\":\"jobid\",\"type\":\"string\"},{\"name\":\"jobStatus\",\"type\":\"string\"}]}");
/*  20:    */   @Deprecated
/*  21:    */   public CharSequence jobid;
/*  22:    */   @Deprecated
/*  23:    */   public CharSequence jobStatus;
/*  24:    */   
...
/*  28:    */   }
/*  29:    */   
/*  30:    */   public JobStatusChanged() {}
/*  31:    */   
/*  32:    */   public JobStatusChanged(CharSequence jobid, CharSequence jobStatus)
/*  33:    */   {
/*  34: 24 */     this.jobid = jobid;
/*  35: 25 */     this.jobStatus = jobStatus;
/*  36:    */   }
/*  37:    */   
...
/*  61:    */     case 1: 
/*  62: 42 */       this.jobStatus = ((CharSequence)value$); break;
/*  63:    */     default: 
...
/*  76:    */   }
/*  77:    */   
/*  78:    */   public CharSequence getJobStatus()
/*  79:    */   {
/*  80: 66 */     return this.jobStatus;
/*  81:    */   }
/*  82:    */   
/*  83:    */   public void setJobStatus(CharSequence value)
/*  84:    */   {
/*  85: 74 */     this.jobStatus = value;
/*  86:    */   }
/*  87:    */   
...
/*  96:    */   }
/*  97:    */   
/*  98:    */   public static Builder newBuilder(JobStatusChanged other)
/*  99:    */   {
/* 100: 89 */     return new Builder(other, null);
/* 101:    */   }
/* 102:    */   
/* 103:    */   public static class Builder
/* 104:    */     extends SpecificRecordBuilderBase<JobStatusChanged>
/* 105:    */     implements RecordBuilder<JobStatusChanged>
/* 106:    */   {
/* 107:    */     private CharSequence jobid;
/* 108:    */     private CharSequence jobStatus;
/* 109:    */     
/* 110:    */     private Builder()
/* 111:    */     {
/* 112:103 */       super();
...
/* 118:    */     }
/* 119:    */     
/* 120:    */     private Builder(JobStatusChanged other)
/* 121:    */     {
/* 122:113 */       super();
...
/* 127:    */       }
/* 128:118 */       if (isValidValue(fields()[1], other.jobStatus))
/* 129:    */       {
/* 130:119 */         this.jobStatus = ((CharSequence)data().deepCopy(fields()[1].schema(), other.jobStatus));
...
/* 158:    */     }
/* 159:    */     
/* 160:    */     public CharSequence getJobStatus()
/* 161:    */     {
/* 162:151 */       return this.jobStatus;
/* 163:    */     }
/* 164:    */     
/* 165:    */     public Builder setJobStatus(CharSequence value)
/* 166:    */     {
/* 167:156 */       validate(fields()[1], value);
/* 168:157 */       this.jobStatus = value;
/* 169:158 */       fieldSetFlags()[1] = 1;
/* 170:159 */       return this;
/* 171:    */     }
/* 172:    */     
/* 173:    */     public boolean hasJobStatus()
/* 174:    */     {
/* 175:164 */       return fieldSetFlags()[1];
/* 176:    */     }
/* 177:    */     
/* 178:    */     public Builder clearJobStatus()
/* 179:    */     {
/* 180:169 */       this.jobStatus = null;
/* 181:170 */       fieldSetFlags()[1] = 0;
/* 182:171 */       return this;
/* 183:    */     }
/* 184:    */     
/* 185:    */     public JobStatusChanged build()
/* 186:    */     {
/* 187:    */       try
/* 188:    */       {
/* 189:177 */         JobStatusChanged record = new JobStatusChanged();
/* 190:178 */         record.jobid = (fieldSetFlags()[0] != 0 ? this.jobid : (CharSequence)defaultValue(fields()[0]));
/* 191:179 */         record.jobStatus = (fieldSetFlags()[1] != 0 ? this.jobStatus : (CharSequence)defaultValue(fields()[1]));
 ...
 * Qualified Name:     org.apache.hadoop.mapreduce.jobhistory.JobStatusChanged
