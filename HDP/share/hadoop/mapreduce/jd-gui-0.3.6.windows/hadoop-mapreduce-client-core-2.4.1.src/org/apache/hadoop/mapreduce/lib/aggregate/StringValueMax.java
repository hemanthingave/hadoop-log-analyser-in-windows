...
/*  9:   */ public class StringValueMax
/* 10:   */   implements ValueAggregator<String>
/* 11:   */ {
/* 12:35 */   String maxVal = null;
/* 13:   */   
/* 14:   */   public StringValueMax()
/* 15:   */   {
/* 16:42 */     reset();
/* 17:   */   }
/* 18:   */   
...
/* 22:54 */     if ((this.maxVal == null) || (this.maxVal.compareTo(newVal) < 0)) {
 ...
 * Qualified Name:     org.apache.hadoop.mapreduce.lib.aggregate.StringValueMax
