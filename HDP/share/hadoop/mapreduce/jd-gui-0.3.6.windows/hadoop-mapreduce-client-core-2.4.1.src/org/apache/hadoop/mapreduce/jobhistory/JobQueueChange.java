...
/*  13:    */ 
/*  14:    */ @AvroGenerated
/*  15:    */ public class JobQueueChange
/*  16:    */   extends SpecificRecordBase
/*  17:    */   implements SpecificRecord
/*  18:    */ {
/*  19: 10 */   public static final Schema SCHEMA$ = new Schema.Parser().parse("{\"type\":\"record\",\"name\":\"JobQueueChange\",\"namespace\":\"org.apache.hadoop.mapreduce.jobhistory\",\"fields\":[{\"name\":\"jobid\",\"type\":\"string\"},{\"name\":\"jobQueueName\",\"type\":\"string\"}]}");
/*  20:    */   @Deprecated
/*  21:    */   public CharSequence jobid;
/*  22:    */   @Deprecated
/*  23:    */   public CharSequence jobQueueName;
/*  24:    */   
...
/*  28:    */   }
/*  29:    */   
/*  30:    */   public JobQueueChange() {}
/*  31:    */   
/*  32:    */   public JobQueueChange(CharSequence jobid, CharSequence jobQueueName)
/*  33:    */   {
/*  34: 24 */     this.jobid = jobid;
/*  35: 25 */     this.jobQueueName = jobQueueName;
/*  36:    */   }
/*  37:    */   
...
/*  49:    */     case 1: 
/*  50: 33 */       return this.jobQueueName;
/*  51:    */     }
...
/*  61:    */     case 1: 
/*  62: 42 */       this.jobQueueName = ((CharSequence)value$); break;
/*  63:    */     default: 
...
/*  76:    */   }
/*  77:    */   
/*  78:    */   public CharSequence getJobQueueName()
/*  79:    */   {
/*  80: 66 */     return this.jobQueueName;
/*  81:    */   }
/*  82:    */   
/*  83:    */   public void setJobQueueName(CharSequence value)
/*  84:    */   {
/*  85: 74 */     this.jobQueueName = value;
/*  86:    */   }
/*  87:    */   
...
/*  96:    */   }
/*  97:    */   
/*  98:    */   public static Builder newBuilder(JobQueueChange other)
/*  99:    */   {
/* 100: 89 */     return new Builder(other, null);
/* 101:    */   }
/* 102:    */   
/* 103:    */   public static class Builder
/* 104:    */     extends SpecificRecordBuilderBase<JobQueueChange>
/* 105:    */     implements RecordBuilder<JobQueueChange>
/* 106:    */   {
/* 107:    */     private CharSequence jobid;
/* 108:    */     private CharSequence jobQueueName;
/* 109:    */     
/* 110:    */     private Builder()
/* 111:    */     {
/* 112:103 */       super();
...
/* 118:    */     }
/* 119:    */     
/* 120:    */     private Builder(JobQueueChange other)
/* 121:    */     {
/* 122:113 */       super();
...
/* 127:    */       }
/* 128:118 */       if (isValidValue(fields()[1], other.jobQueueName))
/* 129:    */       {
/* 130:119 */         this.jobQueueName = ((CharSequence)data().deepCopy(fields()[1].schema(), other.jobQueueName));
...
/* 158:    */     }
/* 159:    */     
/* 160:    */     public CharSequence getJobQueueName()
/* 161:    */     {
/* 162:151 */       return this.jobQueueName;
/* 163:    */     }
/* 164:    */     
/* 165:    */     public Builder setJobQueueName(CharSequence value)
/* 166:    */     {
/* 167:156 */       validate(fields()[1], value);
/* 168:157 */       this.jobQueueName = value;
/* 169:158 */       fieldSetFlags()[1] = 1;
/* 170:159 */       return this;
/* 171:    */     }
/* 172:    */     
/* 173:    */     public boolean hasJobQueueName()
/* 174:    */     {
/* 175:164 */       return fieldSetFlags()[1];
/* 176:    */     }
/* 177:    */     
/* 178:    */     public Builder clearJobQueueName()
/* 179:    */     {
/* 180:169 */       this.jobQueueName = null;
/* 181:170 */       fieldSetFlags()[1] = 0;
/* 182:171 */       return this;
/* 183:    */     }
/* 184:    */     
/* 185:    */     public JobQueueChange build()
/* 186:    */     {
/* 187:    */       try
/* 188:    */       {
/* 189:177 */         JobQueueChange record = new JobQueueChange();
/* 190:178 */         record.jobid = (fieldSetFlags()[0] != 0 ? this.jobid : (CharSequence)defaultValue(fields()[0]));
/* 191:179 */         record.jobQueueName = (fieldSetFlags()[1] != 0 ? this.jobQueueName : (CharSequence)defaultValue(fields()[1]));
 ...
 * Qualified Name:     org.apache.hadoop.mapreduce.jobhistory.JobQueueChange
